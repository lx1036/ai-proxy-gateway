...
import (
	...
	"github.com/lx1036/gateway/pkg/config/labels"
...
type Schema interface {
	...
	ValidateConfig(cfg config.Config) (error, error)
...
func (s *schemaImpl) NewInstance() (config.Spec, error) {
	...
	if rt == nil {
		...
		if err != nil || t == nil {
			return nil, fmt.Errorf("failed to find reflect type")
		}
...
func (s *schemaImpl) ValidateConfig(cfg config.Config) (error, error) {
